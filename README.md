...
| [Advanced Data Science](10.%20Advanced%20Data%20Science/) | Time-series forecasting with hourly ERCOT load | End-to-end notebook validates metadata/schema, profiles regional demand, and benchmarks one-hour-ahead forecasts with leakage-safe baselines |
...
- `10. Advanced Data Science/`: ERCOT hourly load forecasting notebook, metadata notes, and dataset workbook for advanced time-series analysis.
...
| `10. Advanced Data Science/` | Hourly power demand forecasting and benchmark modeling | Notebook-driven ERCOT load analysis with reproducible data validation and baseline forecast evaluation |
