...
![Track](https://img.shields.io/badge/Track-ERCOT%20Load%20Forecasting-0A9396)
...
## Notes
This directory is notebook-centric. The analytical narrative, code, visualizations, and model results are primarily maintained in the `.ipynb` artifact.
...
## Portfolio Highlight
This project demonstrates ERCOT load forecasting execution across data validation, temporal feature engineering, and interpretable forecasting benchmarks for a real-world Texas power demand use case.